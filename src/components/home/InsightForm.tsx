...
const InsightForm = ({ industries }: InsightFormProps) => {
  ...
  // Use the webhook hook for submission with the NEW webhook URL
  const webhookUrl = "https://sonarai.app.n8n.cloud/webhook-test/e5c29c05-b468-4d0f-a2b8-5a78f580e951";
